...
class FakeDetector3(FakeDetector):
    @staticmethod
    def name() -> str:
        return "ip_errors"
...
class TestTrainingHistoricalMode(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
    ...
    async def test_time_frame_before(self):
        ...
        assert self.context.detectors['ip_rps'].start_at == 1751535000
