 ...
 *
 * Error injection library is used to check handling various
 * situations that cannot be reproduced by traditional python
 * tests. For example we may change return code of some Linux
 * kernel functions and so on.
 *
