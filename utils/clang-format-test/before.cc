...
else if(a<0) return -1; // This should be on separate lines
else return 0;
}
...
void badly_aligned_function(int a,char *b,double c,
bool d,
std::string e) {
}
...
very_long_function_name_with_many_parameters(42,
                                           "test string",
                                           3.14,
                                           true,
                                           {1, 2, 3});
...
badly_aligned_function(123,"hello",2.5,
false,"world");
...
T complex_template_function(T first,U second,
V third,int fourth) {
return T{};
}
