...
static const TfwField tfw_fields[] = {
	...
	[TFW_MMAP_LOG_TFT]		= {"tft", clickhouse::Type::UInt64},
	[TFW_MMAP_LOG_TFH]		= {"tfh", clickhouse::Type::UInt64},
...
#define READ_STR(method)						\
	...
	READ_INT(TFW_MMAP_LOG_TFT, clickhouse::ColumnUInt64, uint64_t);
	READ_INT(TFW_MMAP_LOG_TFH, clickhouse::ColumnUInt64, uint64_t);
