...
#define FRAME_SETTINGS_MAX_ENTRIES	32
#define FRAME_SETTINGS_MAX_ALLOC	(FRAME_SETTINGS_MAX_ENTRIES * \
...
typedef enum {
	...
	_HTTP2_SETTINGS_MAX = HTTP2_SETTINGS_MAX_HDR_LIST_SIZE
} TfwSettingsId;
