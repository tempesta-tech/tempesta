...
int tfw_http_msg_setup(TfwHttpMsg *hm, TfwMsgIter *it, size_t max_len, size_t data_len,
...
int tfw_http_msg_setup_transform_pool(TfwHttpTransIter *mit, TfwMsgIter *it,
				      TfwPool* pool);
