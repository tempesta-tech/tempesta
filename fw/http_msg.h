...
int tfw_http_msg_expand_from_pool(TfwHttpResp *resp, const TfwStr *str, bool force);
int tfw_http_msg_expand_from_pool_lc(TfwHttpResp *resp, const TfwStr *str, bool force);
