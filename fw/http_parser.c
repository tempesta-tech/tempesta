	...
	__FSM_STATE(I_ContType) {
		...
		case 'i':
			if (likely(__data_available(p, 5)
				   && (C4_INT(p + 1, 'm', 'a', 'g', 'e'))
				   && *(p + 5) == '/')) {
				__FSM_I_MOVE_fixup(I_ContTypeImageSubtype, 6, 0);
			}
		...
		case 'v':
			if (likely(__data_available(p, 5)
				   && (C4_INT(p + 1, 'i', 'd', 'e', 'o'))
				   && *(p + 5) == '/')) {
				__FSM_I_MOVE_fixup(I_ContTypeVideoSubtype, 6, 0);
			}
		...
		case 'a':
			if (likely(__data_available(p, 5)
				   && (C4_INT(p + 1, 'u', 'd', 'i', 'o'))
				   && *(p + 5) == '/')) {
				__FSM_I_MOVE_fixup(I_ContTypeAudioSubtype, 6, 0);
			}
	...
	__FSM_STATE(I_ContTypeImageSubtype) {
		...
		case 'j':
			if (likely(__data_available(p, 4)
				 ...
				 */
				__FSM_I_MOVE_fixup(I_ContTypeImageSubtypePjpeg, 4, 0);
			__FSM_I_MOVE(I_ContTypeImageSubtypePj);
		case 'p':
			if (__data_available(p, 5)
			   && (C4_INT(p + 1, 'j', 'p', 'e', 'g')))
				__FSM_I_MOVE_fixup(I_ContTypeImageSubtypePjpeg, 5, 0);
