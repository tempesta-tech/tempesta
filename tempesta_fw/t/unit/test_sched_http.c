...
TEST(tfw_sched_http, one_wildcard_rule)
{
	...
	tfw_connection_get(&expect_conn->conn);
...
TEST(tfw_sched_http, some_rules)
{
	...
	tfw_connection_get(&expect_conn1->conn);
	...
	tfw_connection_get(&expect_conn2->conn);
	...
	tfw_connection_get(&expect_conn3->conn);
	...
	tfw_connection_get(&expect_conn4->conn);
	...
	tfw_connection_get(&expect_conn5->conn);
	...
	tfw_connection_get(&expect_conn6->conn);
	...
	tfw_connection_get(&expect_conn7->conn);
	...
	tfw_connection_get(&expect_conn8->conn);
	...
	tfw_connection_get(&expect_conn9->conn);
	...
	tfw_connection_get(&expect_conn10->conn);
