...
#ifdef DEBUG
/* The parsing routine is exported only for tests. Normally you don't use it. */
 ...
 *   };
 *   TfwCfgSpec specs[] = {
 *       { "option", tfw_cfg_set_enum, &(TfwCfgEnumSpec){ &value, mappings } }
 *       {},
 *   };
 */
