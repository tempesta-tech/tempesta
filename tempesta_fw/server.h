 ...
 *		  result of underlying @sched_sg();
 * @sched_sg	- requests scheduling virtual method, can be called in heavy
 ...
 * server group, i.e. @sched_sg must be defined.
 ...
 * @sched_sg callback or @sched_srv of the target scheduler.
 */
struct tfw_scheduler_t {
	...
	TfwSrvConn		*(*sched_sg)(TfwMsg *msg, TfwSrvGroup *sg);
	TfwSrvConn		*(*sched_srv)(TfwMsg *msg, TfwServer *srv);
};
