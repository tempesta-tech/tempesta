...
tfw_sched_http_sched_grp(TfwMsg *msg)
{
	...
	srv_conn = sg->sched->sched_sg(msg, sg);
...
static TfwSrvConn *
tfw_sched_http_sched_sg(TfwMsg *msg, TfwSrvGroup *sg)
{
...
static TfwSrvConn *
tfw_sched_http_sched_srv(TfwMsg *msg, TfwServer *sg)
{
...
static TfwScheduler tfw_sched_http = {
	...
	.sched_sg	= tfw_sched_http_sched_sg,
