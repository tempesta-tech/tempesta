...
bool tfw_apm_hm_srv_status_alive(int status, void *apmref);
bool tfw_apm_hm_srv_crc32_alive(u32 crc32, void *apmref);
...
bool tfw_apm_get_hm(const char *name, void **hm);
