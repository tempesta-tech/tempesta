...
{
	pr_info("MBEDTLS_BIGNUM_C and/or MBEDTLS_CERTS_C and/or "
		...
		"MBEDTLS_X509_CRT_PARSE_C and/or MBEDTLS_PEM_PARSE_C "
		"not defined.\n");
	return 0;
}
#else
...
tfw_ssl_srv_init(void)
{
	...
	/*
	 * This demonstration program uses embedded test certificates. Instead,
	 * you may want to use mbedtls_x509_crt_parse_file() to read the server
	 * and CA certificates, as well as mbedtls_pk_parse_keyfile().
	 */
