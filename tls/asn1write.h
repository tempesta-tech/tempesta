...
/**
 * \brief		   Write an OID tag (TTLS_ASN1_OID) and data in ASN.1 format
 *				  Note: function works backwards in data buffer
 *
 * \param p		 reference to current position pointer
 * \param start	 start of the buffer (for bounds-checking)
...
/**
 * \brief		   Write an int tag (TTLS_ASN1_INTEGER) and value in ASN.1 format
 *				  Note: function works backwards in data buffer
 *
 * \param p		 reference to current position pointer
 * \param start	 start of the buffer (for bounds-checking)
...
/**
 * \brief		   Write a printable string tag (TTLS_ASN1_PRINTABLE_STRING) and
